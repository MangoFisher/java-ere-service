...
public class ChangeInfo {
    ...
    private Boolean signatureChange; // 方法签名是否变更（仅Method类型）
    private String scope; // 变量作用域（仅Field类型）："ClassOrInterface"=类成员变量, "Method"=方法局部变量
    ...
    public java.util.List<String> getAddedLines() {
        return addedLines;
    }

    public void setAddedLines(java.util.List<String> addedLines) {
        this.addedLines = addedLines;
    }

    public java.util.List<String> getRemovedLines() {
        return removedLines;
    }

    public void setRemovedLines(java.util.List<String> removedLines) {
        this.removedLines = removedLines;
    }

    public java.util.List<String> getContextLines() {
        return contextLines;
    }

    public void setContextLines(java.util.List<String> contextLines) {
    ...
    public String toString() {
        return (
            ...
            '\'' +
            ", addedLines=" +
            (addedLines != null ? addedLines.size() : 0) +
            ", removedLines=" +
